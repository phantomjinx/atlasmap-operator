...
func GetClusterVersionSemVer(ctx context.Context, config *rest.Config) *semver.Version {
...
func IsOpenShift43Plus(ctx context.Context, config *rest.Config) bool {
	openShiftSemVer := GetClusterVersionSemVer(ctx, config)
